...
Postman은 크롬 브라우저의 확장 프로그램으로 구글 웹스토어에서 설치할 수 있습니다.
...
postman과 같이 크롬 확장프로그램으로 구글 검색 후 설치할 수 있으며 상단의 Postman Interceptor메뉴를 통해 활성화 할 수 있습니다.

![확장](./postmaninterceptor.png)
